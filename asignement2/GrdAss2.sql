	...
	db.customers.insertMany([
	  {
		...
		"address": { "street": "1-127 new colony", "city": "Springbroard", "zipcode": "33435" }, 
		"phone": "555-1234", 
	  ...
	  },
	  {
		...
		"address": { "street": "NBJHB", "city": "HDHD", "zipcode": "35436" },
		"phone": "123456789",
	  ...
	  },
	  {
		"name": "Sai",
		"email": "Sai@gamil.com",
		"address": { "street": "GHJHG", "city": "andhra", "zipcode": "533449" },
		"phone": "123456789",
	  ...
	  },
	  {
		...
		"address": { "street": "134", "city": "anvarram", "zipcode": "466877" },
		"phone": "123456789",
	  ...
	  },
	  {
		...
		"address": { "street": "202", "city": "konga", "zipcode": "112347" },
		"phone": "123456789",
...
//3.2.	Find All Products Ordered by a Specific Customer:
	...
	let customer = db.customers.findOne({ "name": "Aravind" });
