...
func main() {
	...
	// Add some employees
	errors := []error{
		manager.AddEmployee(1, "Kurra Venky", 31, "IT"),
		manager.AddEmployee(2, "Manikanta", 24, "HR"),
		manager.AddEmployee(3, "Nikhil", 37, "IT"),
		manager.AddEmployee(4, "Abhishek ", 25, "FINANCE"),
	}
	...
	// Search by name
	employees, err := manager.SearchByName("Manikanta")
	if err != nil {
		fmt.Printf("Search error: %v\n", err)
	} else {
